...
class Verification extends StatelessWidget {
  Verification({Key? key, required this.typeOperation}) : super(key: key);
                    ...
                    Flexible(
                      ...
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          ...
                          borderSide:
                              BorderSide(color: ColorsApp.border, width: 2.0),
                        ),
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: ColorsApp.primary, width: 2.0)),
                            ...
                            Provider.of<SignUpDAO>(context, listen: false)
                              ...
                              if (value) {
                                switch (typeOperation) {
                                  case TypeOperation.CREATE_ACCOUNT:
                                    {
                                      await Provider.of<SignUpDAO>(context,
                                              listen: false)
                                          .createUser();
                                      Config.setVerification(false);
                                      Navigator.push(
                                    ...
                                    break;
                                  case TypeOperation.RESET_PASSWORD:
                                    {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
